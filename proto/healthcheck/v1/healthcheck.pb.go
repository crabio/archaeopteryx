...
func (HealthCheckResponse_ServingStatus) EnumDescriptor() ([]byte, []int) {
	return file_healthcheck_v1_healthcheck_proto_rawDescGZIP(), []int{1, 0}
}
...
var file_healthcheck_v1_healthcheck_proto_rawDesc = []byte{
	...
	0x63, 0x65, 0x22, 0xcb, 0x01, 0x0a, 0x13, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x43, 0x68, 0x65,
	...
	0x32, 0xb3, 0x01, 0x0a, 0x0b, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x43, 0x68, 0x65, 0x63, 0x6b,
	...
	0x73, 0x65, 0x12, 0x52, 0x0a, 0x05, 0x57, 0x61, 0x74, 0x63, 0x68, 0x12, 0x22, 0x2e, 0x68, 0x65,
	0x61, 0x6c, 0x74, 0x68, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x2e, 0x76, 0x31, 0x2e, 0x48, 0x65, 0x61,
	0x6c, 0x74, 0x68, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	0x23, 0x2e, 0x68, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x2e, 0x76, 0x31,
	...
	0x2f, 0x61, 0x72, 0x63, 0x68, 0x61, 0x65, 0x6f, 0x70, 0x74, 0x65, 0x72, 0x79, 0x78, 0x3b, 0x68,
...
var file_healthcheck_v1_healthcheck_proto_goTypes = []interface{}{
	...
	(*HealthCheckRequest)(nil),             // 1: healthcheck.v1.HealthCheckRequest
	(*HealthCheckResponse)(nil),            // 2: healthcheck.v1.HealthCheckResponse
}
var file_healthcheck_v1_healthcheck_proto_depIdxs = []int32{
	0, // 0: healthcheck.v1.HealthCheckResponse.status:type_name -> healthcheck.v1.HealthCheckResponse.ServingStatus
	1, // 1: healthcheck.v1.HealthCheck.Check:input_type -> healthcheck.v1.HealthCheckRequest
	1, // 2: healthcheck.v1.HealthCheck.Watch:input_type -> healthcheck.v1.HealthCheckRequest
	2, // 3: healthcheck.v1.HealthCheck.Check:output_type -> healthcheck.v1.HealthCheckResponse
	2, // 4: healthcheck.v1.HealthCheck.Watch:output_type -> healthcheck.v1.HealthCheckResponse
