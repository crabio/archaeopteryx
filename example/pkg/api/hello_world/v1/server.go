...
func RegisterServiceServer(s grpc.ServiceRegistrar, controllers interface{}) error {
...
func RegisterProxyServiceServer(mux *runtime.ServeMux, conn *grpc.ClientConn, controllers interface{}) error {
